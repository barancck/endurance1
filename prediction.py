    ...
    fire_dir = '<fire directory here>'
    no_fire_dir = '<fire directory here>'
    ...
    def load_data(directory, max_files=50):
        ...
        for filename in selected_files:
            ...
            data = data.drop(columns=['row', 'col'])  # Drop columns A and B
    ...
    X = data.drop(columns=['Probability'])  # Change the name of the column based on the CSV data
    y = data['Probability']
